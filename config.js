...
module.exports = {
    ...
    BOT_NAME: "HUSE-TECH Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ HUSE-TECH',
    ...
    CHANNEL_INVITE_LINK: process.env.CHANNEL_INVITE_LINK || 'https://whatsapp.com/channel/0029VazoKtJ9MF8zrCJVX01w',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.supaimg.com/e2dd832e-5ef4-4337-9d13-4d178ae0f0b0/06bb89b3-9544-496c-870d-0d146f500870.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb1sO3U0gcfFaZaYnJ2B/9611',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8950686469:AAFf6jkScQ9KU0RK6Z_wL9hutVuVC8G0HfA',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8384623013'
